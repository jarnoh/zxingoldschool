...
final class QRCodeEncoder {
  ...
  private void encodeQRCodeContents(Intent intent, String type) {
	  if(Contents.Type.TEXT.equalsIgnoreCase(type)){
		  String data = intent.getStringExtra(Intents.Encode.DATA);
	      if (data != null && !data.isEmpty()) {
	        contents = data;
	        displayContents = data;
	  ...
	  }else if(Contents.Type.EMAIL.equalsIgnoreCase(type)){
	  ...
	  }else if(Contents.Type.PHONE.equalsIgnoreCase(type)){
		  String data = ContactEncoder.trim(intent.getStringExtra(Intents.Encode.DATA));
	      if (data != null) {
	        contents = "tel:" + data;
	  ...
	  }else if(Contents.Type.SMS.equalsIgnoreCase(type)){
		  String data = ContactEncoder.trim(intent.getStringExtra(Intents.Encode.DATA));
	      if (data != null) {
	        contents = "sms:" + data;
	        displayContents = PhoneNumberUtils.formatNumber(data);
	  ...
	  }else if(Contents.Type.CONTACT.equalsIgnoreCase(type)){
	  ...
	  }else if(Contents.Type.LOCATION.equalsIgnoreCase(type)){
		  Bundle bundle = intent.getBundleExtra(Intents.Encode.DATA);
	      if (bundle != null) {
